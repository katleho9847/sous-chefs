      ...
      <div className="max-w-md mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="bg-card-gradient rounded-xl p-4 text-center border border-border/50">
            <div className="text-2xl font-bold text-primary mb-1">{allRecipes.length}</div>
            <div className="text-xs text-muted-foreground">Saved Recipes</div>
          </div>
          <div className="bg-card-gradient rounded-xl p-4 text-center border border-border/50">
            <div className="text-2xl font-bold text-secondary mb-1">12</div>
            <div className="text-xs text-muted-foreground">Cooked This Week</div>
          </div>
          <div className="bg-card-gradient rounded-xl p-4 text-center border border-border/50">
            <div className="flex items-center justify-center gap-1 mb-1">
              <Clock className="w-4 h-4 text-primary" />
              <div className="text-lg font-bold text-foreground">28m</div>
            </div>
            <div className="text-xs text-muted-foreground">Avg Cook Time</div>
          </div>
        </div>
